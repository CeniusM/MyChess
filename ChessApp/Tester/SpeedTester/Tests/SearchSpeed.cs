...
namespace MyChess.SpeedTester.Tests
{
    partial class Test
    {
        ...
        public static void TimeSearch()
        {
            ...
            // -- for testing and seeing reults --

            // Print(PerftSearchWithTime("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 193690690, 5));

            // before 110443ms, without power and with chrome open and with cpu sampleling

            // for reals :D
            // before 40932ms, with power, with no cpu sampeling, and only vs open in release mode

            // after removing makemove and unmakemove
            // 27956ms

            // now time for FastIsSquareAttacked
            // 13234ms
            // IT WENT FROM 40seconds down to just 13
