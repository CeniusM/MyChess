...
namespace MyChess.UnitTester.Tests
{
    partial class Test
    {
        public static void PerftResults()
        {
            ...
            // CS_MyConsole.MyConsole.WriteLine(PerftResultSearch(false, "8/8/6k1/8/8/2K5/8/8 w - - 0 1", 0, 8));
            CS_MyConsole.MyConsole.WriteLine(PerftResultSearch(false, "8/8/6k1/8/8/2K5/8/8 w - - 0 1", 54948733, 9));
