...
namespace MyChess.UnitTester
{
    class TestRunner
    {
        public static void Run()
        {
            ...
            PrintReport(Test.NumberOfPositionsAfter5plies("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 400, 2));
            PrintReport(Test.NumberOfPositionsAfter5plies("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 8902, 3));
            PrintReport(Test.NumberOfPositionsAfter5plies("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 197281, 4));
            PrintReport(Test.NumberOfPositionsAfter5plies("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 4865609, 5));
            ...
            // test casteling
            PrintReport(Test.NumberOfPositionsAfter5plies("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 48, 1));
            PrintReport(Test.NumberOfPositionsAfter5plies("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 2039, 2));
            PrintReport(Test.NumberOfPositionsAfter5plies("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 97862, 3));
            PrintReport(Test.NumberOfPositionsAfter5plies("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 4085603, 4));
            PrintReport(Test.NumberOfPositionsAfter5plies("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 193690690, 5));
            PrintReport(Test.NumberOfPositionsAfter5plies("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 8031647685, 6));

            // no casteling
            PrintReport(Test.NumberOfPositionsAfter5plies("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10 ", 46, 1));
            PrintReport(Test.NumberOfPositionsAfter5plies("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10 ", 2079, 2));
            PrintReport(Test.NumberOfPositionsAfter5plies("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10 ", 89890, 3));
            PrintReport(Test.NumberOfPositionsAfter5plies("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10 ", 3894594, 4));
            PrintReport(Test.NumberOfPositionsAfter5plies("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10 ", 164075551, 5));
            PrintReport(Test.NumberOfPositionsAfter5plies("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 6923051137, 6));



            // PrintReport(Test.NumberOfPositionsAfter5plies("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", 3195901860, 7));
            ...
            // Test.Search("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 6);
            // Test.Search("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 5);
            // Test.Search("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 6);
            // Test.Search("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 6);
